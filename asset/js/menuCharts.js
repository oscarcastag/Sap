...
function chatCountPreciosxMat() {
    ...
    document.getElementById("countMateriales").innerHTML = 2275;
...
//    var myObj = JSON.parse(serverRequest);
    ...
    //console.log(count);
    document.getElementById("countCliente").innerHTML = 835;
    $({Counter: 0}).animate({
...
//    console.log(count);
    ...
    document.getElementById("countExist").innerHTML = 35;
